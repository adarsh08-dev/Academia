...
import { CareerLadderView } from './pages/CareerLadderView';
...
export const App: React.FC = () => {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    {
      id: 'n1',
      title: 'New Clinical Rotation Available',
      message: 'AIIMS Apex Trauma Center posted an ICU Sepsis Protocol Observership with ₹30,000 stipend.',
      time: '10m ago',
      type: 'gig',
      read: false
    },
    {
      id: 'n2',
      title: 'Grand Rounds Case Review Confirmed',
      message: 'Your 15-minute clinical case review with Prof. Dr. Vikramaditya Roy (AIIMS) is confirmed for 4:00 PM.',
      time: '1h ago',
      type: 'mentor',
      read: false
    },
    {
      id: 'n3',
      title: 'Clinical Passport Badge Minted',
      message: 'Emergency Medicine & ACLS Resuscitation rotation proof has been cryptographically verified on your ledger.',
      time: '3h ago',
      type: 'passport',
      read: true
    }
