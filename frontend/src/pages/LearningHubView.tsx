...
const DEFAULT_COURSE_LESSONS: Record<string, CourseLesson[]> = {
  'course-1': [
    {
      id: 'l1-1',
      title: 'ICH-GCP E6(R2) Principles & Investigator Responsibilities',
      duration: '45 mins',
      type: 'video',
      completed: true,
      summary: 'Deep dive into ICH-GCP ethical standards, investigator trial site duties, and source data documentation.'
    },
    {
      id: 'l1-2',
      title: 'Designing Case Report Forms (CRF) & Clinical Trial Protocols',
      duration: '55 mins',
      type: 'lab',
      completed: false,
      summary: 'Design a multi-site clinical trial protocol with inclusion/exclusion criteria, randomization, and safety endpoints.',
      codeSnippet: `// ICMR / GCP Trial Protocol Outline
{
  "trialId": "ICMR-CT-2026-089",
  "phase": "Phase III Randomized Controlled Trial",
  "endpoint": "30-day all-cause mortality reduction",
  "blinding": "Double-Blind, Placebo-Controlled",
  "monitoring": "Data Safety Monitoring Board (DSMB) review every 4 weeks"
}`
    },
    {
      id: 'l1-3',
      title: 'Institutional Review Board (IRB) Submission & Ethics Approval',
      duration: '50 mins',
      type: 'lab',
      completed: false,
      summary: 'Submitting clinical research dossiers for institutional ethics committee review and regulatory approval.'
    },
    {
      id: 'l1-4',
      title: 'Adverse Event (AE) vs Serious Adverse Event (SAE) Reporting Protocols',
      duration: '40 mins',
      type: 'video',
      completed: false,
      summary: 'Timely 24-hour notification procedures to regulatory authorities (DCGI/CDSCO) for unexpected clinical reactions.'
    }
  ],
  'course-2': [
    {
      id: 'l2-1',
      title: 'Electronic Health Records (EHR) Architecture & Clinical Standards',
      duration: '40 mins',
      type: 'video',
      completed: true,
      summary: 'Structural overview of EHR repositories, Ayushman Bharat Digital Mission (ABDM), and longitudinal health records.'
    },
    {
      id: 'l2-2',
      title: 'HL7 FHIR Patient & Observation Resource Data Standards',
      duration: '60 mins',
      type: 'lab',
      completed: true,
      summary: 'Implementing FHIR JSON resources for bedside vital signs and laboratory diagnostic panels.',
      codeSnippet: `// HL7 FHIR Diagnostic Observation
{
  ...
  "subject": { "reference": "Patient/IN-AIIMS-7842" },
  "valueQuantity": { "value": 68.5, "unit": "kg" }
}`
    },
    {
      id: 'l2-3',
      title: 'Clinical Decision Support (CDS) Hooks & Alert Fatigue Management',
      duration: '65 mins',
      type: 'lab',
      completed: false,
      summary: 'Designing rational clinical alerts for drug-drug interactions and antimicrobial dosing adjustments.'
    },
    {
      id: 'l2-4',
      title: 'Telemedicine Systems & ABDM Milestone Compliance',
      duration: '45 mins',
      type: 'video',
      completed: false,
      summary: 'Integrating telemedicine consults with consent managers and ABHA patient identifiers.'
    }
  ],
  'course-3': [
    {
      id: 'l3-1',
      title: 'Hypothesis Testing & P-Value Interpretation in Clinical Research',
      duration: '35 mins',
      type: 'video',
      completed: true,
      summary: 'Parametric vs non-parametric tests, Type I/II errors, and interpreting confidence intervals in JAMA/NEJM studies.'
    },
    {
      id: 'l3-2',
      title: 'Kaplan-Meier Survival Analysis & Hazard Ratios in R',
      duration: '45 mins',
      type: 'lab',
      completed: true,
      summary: 'Calculating log-rank p-values and multivariate Cox proportional hazards models for clinical endpoints.',
      codeSnippet: `// R Clinical Trial Survival Analysis
library(survival)
km_fit <- survfit(Surv(time_months, event_status) ~ treatment_arm, data = clinical_trial)
summary(km_fit)
cox_model <- coxph(Surv(time_months, event_status) ~ treatment_arm + age + comorbidities, data = clinical_trial)
summary(cox_model)`
    },
    {
      id: 'l3-3',
      title: 'Sample Size Calculation & Power Analysis in Clinical Trials',
      duration: '50 mins',
      type: 'lab',
      completed: true,
      summary: 'Determining patient recruitment requirements to achieve 80% statistical power with alpha 0.05.'
    },
    {
      id: 'l3-4',
      title: 'Epidemiological Study Designs: Cohort vs Case-Control vs RCTs',
      duration: '40 mins',
      type: 'reading',
      completed: true,
      summary: 'Evaluating relative risk (RR), odds ratios (OR), and controlling for confounding biases in clinical epidemiology.'
    }
  ],
  'course-4': [
    {
      id: 'l4-1',
      title: 'Pharmacovigilance Principles & MedDRA Terminology Classification',
      duration: '40 mins',
      type: 'video',
      completed: true,
      summary: 'Systematic classification of adverse reactions using standardized MedDRA system organ classes (SOC).'
    },
    {
      id: 'l4-2',
      title: 'Individual Case Safety Reports (ICSR) & E2B Transmission',
      duration: '55 mins',
      type: 'lab',
      completed: true,
      summary: 'Formulating suspect drug causality assessments using Naranjo algorithms and WHO-UMC criteria.'
    },
    {
      id: 'l4-3',
      title: 'Disproportionality Analysis & Drug Safety Signal Detection',
      duration: '45 mins',
      type: 'lab',
      completed: true,
      summary: 'Computing proportional reporting ratios (PRR) and reporting odds ratios (ROR) on global pharmacovigilance datasets.'
    }
  ],
  'course-5': [
    {
      id: 'l5-1',
      title: 'Clinical Communication & Breaking Bad News (SPIKES Protocol)',
      duration: '30 mins',
      type: 'reading',
      completed: true,
      summary: 'Setting, Perception, Invitation, Knowledge, Emotions, and Strategy/Summary clinical communication framework.'
    },
    {
      id: 'l5-2',
      title: 'Interprofessional Team Dynamics in High-Acuity ICU & OT Settings',
      duration: '45 mins',
      type: 'video',
      completed: false,
      summary: 'SBAR (Situation-Background-Assessment-Recommendation) structured handover protocols in emergency transfers.'
    },
    {
      id: 'l5-3',
      title: 'Patient Autonomy, Informed Consent & Medical Ethics (NMC Guidelines)',
      duration: '35 mins',
      type: 'reading',
      completed: false,
      summary: 'Navigating surrogate consent, living wills, and emergency triage ethics under National Medical Commission guidelines.'
    }
  ]
};
