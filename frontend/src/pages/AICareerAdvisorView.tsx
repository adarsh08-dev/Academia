...
export const AICareerAdvisorView: React.FC<AICareerAdvisorViewProps> = ({ 
  ...
  const predefinedPrompts = [
    "What priority clinical competencies should I learn next?",
    "Am I eligible for AIIMS & Fortis Residency Matching?",
    "Generate 30-day clinical rotation preparation roadmap",
    "How do I bridge my Pharmacology & Clinical Audit skill gaps?"
  ];
