              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs font-semibold text-white capitalize truncate">
                    {currentRole === 'hod' ? 'Medical Faculty / Dean' : currentRole === 'mentor' ? 'Clinician Mentor' : currentRole === 'company' ? 'Healthcare Organization' : 'Medical Scholar & Resident'}
                  </p>
                </div>
              </div>
            ...
            <>
              ...
              <div>
                ...
                <div className="space-y-0.5">
                  ...
                  <button
                    id="nav-career-ladder"
                    onClick={() => handleTabClick('career-ladder')}
                    title="7-Step Career Ladder"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                  ...
                  >
                    ...
                    {!collapsed && (
                      <div className="flex items-center justify-between w-full min-w-0">
                        <span className="truncate">Career Ladder</span>
                        <span className="text-[9px] bg-emerald-500/20 text-emerald-300 font-bold px-1.5 py-0.5 rounded shrink-0">
                          7 Steps
                        </span>
                      </div>
                    )}
                  ...
                  <button
                    ...
                    title="Clinical Skill Intelligence"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'skills'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Clinical Intelligence</span>}
                  </button>
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Clinical Assessment</span>}
                  </button>
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Skill Gap Diagnostics</span>}
                  </button>
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Medical Learning Hub</span>}
                  </button>
                </div>
              </div>

              {/* Category 2: Hospital Rotations & Research */}
              <div>
                {!collapsed && (
                  <div className="px-2.5 mb-1.5 text-[10px] font-bold text-white/30 uppercase tracking-[1.5px]">
                    Rotations & Research
                ...
                <div className="space-y-0.5">
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Hospital Rotations & Jobs</span>}
                  </button>
                  ...
                  <button
                    ...
                    title="Clinical Micro-Rotations"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'gigs'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Micro-Rotations</span>}
                  </button>

                  <button
                    id="nav-projects"
                    onClick={() => handleTabClick('projects')}
                    title="Clinical Research Hub & Trials"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'projects'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Research Hub & ICMR Grants</span>}
                  </button>

                  <button
                    id="nav-mentors"
                    onClick={() => handleTabClick('mentors')}
                    title="Clinician Mentor Match (15 Min)"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'mentors'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && (
                      <div className="flex items-center justify-between w-full min-w-0">
                        <span className="truncate">Clinician Mentors</span>
                        <span className="text-[9px] bg-pink-500/20 text-pink-300 font-bold px-1.5 py-0.5 rounded shrink-0">
                          15 Min
                        </span>
                      </div>
                    )}
              ...
              {/* Category 3: Verified Credentials & AI Intelligence */}
              <div>
                {!collapsed && (
                  <div className="px-2.5 mb-1.5 text-[10px] font-bold text-white/30 uppercase tracking-[1.5px]">
                    Credentials & AI
                ...
                <div className="space-y-0.5">
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Medical CV & Portfolio</span>}
                  </button>

                  <button
                    id="nav-certs"
                    onClick={() => handleTabClick('certs')}
                    title="Accreditations & Badges"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'certs'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Medical Accreditations</span>}
                  </button>

                  <button
                    id="nav-passport"
                    onClick={() => handleTabClick('passport')}
                    title="LADDER Skill Passport"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'passport'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">LADDER Skill Passport</span>}
                  </button>

                  <button
                    id="nav-advisor"
                    onClick={() => handleTabClick('advisor')}
                    title="AI Clinical & Career Advisor"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'advisor'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">AI Clinical Advisor</span>}
                  </button>

                  <button
                    id="nav-helpdesk"
                    onClick={() => handleTabClick('helpdesk')}
                    title="Medical Help Desk (Bridge Buddy)"
                    className={`w-full flex items-center ${collapsed ? 'justify-center w-10 h-10 mx-auto px-0 py-0 gap-0' : 'gap-3 px-2.5 py-2'} rounded-xl text-[13px] font-semibold transition-all ${
                      activeTab === 'helpdesk'
                        ? 'bg-[#7C5CFC]/20 text-[#C4B5FD] border border-[#7C5CFC]/30 shadow-sm font-bold'
                        : 'text-slate-300 hover:bg-white/5 hover:text-white'
                  ...
                  >
                    ...
                    {!collapsed && <span className="truncate">Medical Help Desk</span>}
                  </button>
                </div>
              </div>
            </>
