...
export const AuthPortal: React.FC<AuthPortalProps> = ({
  ...
  const getCurrentLocation = async (): Promise<{ location: string; lat: number; lng: number }> => {
    try {
      ...
      const fallback = 'New Delhi, Delhi, India';
      setDetectedLocation(fallback);
      return { location: fallback, lat: 28.5672, lng: 77.2100 };
    }
  };
    ...
    try {
      ...
      if (roleTab === 'Student') {
        form = {
          ...
          dept: studentDept,
          roll: studentRollNo.trim() || 'MED-2022-AIIMS-084',
          year: academicYear
        };
        ...
        form = {
          name: mentorName.trim() || 'Dr. Vikramaditya Roy',
          email: mentorEmail.trim() || 'vikram.roy@apollohospitals.com',
          company: comp,
          uni: 'Healthcare Industry & Clinical Research',
          dept: 'Cardiology & Clinical Trials',
          year: 'N/A'
        };
        targetUserRole = 'mentor';
      } else if (roleTab === 'HOD') {
        form = {
          name: hodName.trim() || 'Prof. (Dr.) Arvind K. Sharma',
          email: hodEmail.trim() || 'dean.clinical@aiims.edu',
          uni: hodCollege.name,
          dept: hodDept,
          year: 'N/A'
        };
        ...
        form = {
          name: recruiterName.trim() || 'Dr. Priya Sharma',
          email: recruiterEmail.trim() || 'talent.acquisition@apollohospitals.com',
          company: recruiterCompany.trim() || 'Apollo Hospitals Enterprise',
          uni: 'Healthcare Organization',
          dept: 'Clinical Talent & Medical Affairs',
          year: 'N/A'
        };
              ...
              {authMode === 'register' ? (
                <div className="space-y-3.5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="e.g. MED-2022-AIIMS-084"
                          className="w-full bg-[#1A1F3D] border border-white/10 focus:border-[#7C5CFC] rounded-xl pl-9 pr-3 py-2 text-xs text-white placeholder-slate-500 outline-none"
                        />
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          <option value="Final Year MBBS / Clinical Intern">Final Year MBBS / Clinical Intern</option>
                          <option value="Pre-Final Year MBBS (Part 1)">Pre-Final Year MBBS (Part 1)</option>
                          <option value="2nd Professional MBBS">2nd Professional MBBS</option>
                          <option value="1st Professional MBBS (Foundation)">1st Professional MBBS (Foundation)</option>
                          <option value="Postgraduate Resident (MD/MS/DNB)">Postgraduate Resident (MD/MS/DNB)</option>
                  ...
                  <UniversityDropdown
                    ...
                    label="Medical Institution / Teaching Hospital"
                  />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="adarsh.singh@aiims.edu"
                          className="w-full bg-[#1A1F3D] border border-white/10 focus:border-[#7C5CFC] rounded-xl pl-9 pr-3 py-2 text-xs text-white placeholder-slate-500 outline-none"
                        />
                      </div>
                    </div>
