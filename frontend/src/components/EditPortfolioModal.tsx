...
export const EditPortfolioModal: React.FC<EditPortfolioModalProps> = ({
  ...
  const handleAddProject = () => {
    const newProj: ProjectItem = {
      id: `proj-${Date.now()}`,
      title: 'Multicentric Clinical Audit & Case Study',
      type: 'Clinical Audit',
      ...
      description: 'Conducted a clinical protocol compliance audit evaluating antibiotic stewardship and sepsis bundle turnaround times.',
      deliverables: ['Clinical Protocol Logbook', 'Audit Presentation', 'IRB Ethics Documentation'],
      status: 'Available',
      bountyReward: 2000,
      partnerCompany: 'AIIMS Research Foundation'
    };
  ...
  const handleAddCert = () => {
    const newCert: CertificationItem = {
      ...
      issuer: 'American Heart Association / AIIMS Clinical Skills Center',
      issueDate: '2026-08',
      expiryDate: '2028-08',
      credentialId: `ACLS-${Math.floor(100000 + Math.random() * 900000)}`,
      skillsVerified: ['Emergency Resuscitation', 'BLS/ACLS', 'Airway Management'],
      verificationUrl: 'https://cpr.heart.org'
    };
